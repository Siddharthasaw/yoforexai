...
const chartRequirements = [
  { id: 1, title: 'Timeframe', description: 'Use 15m, 30min, or 45min for scalping analysis', completed: true },
...
const recentUploads = [
  { pair: 'EUR/USD 15m', time: 'Today, 10:32 AM', status: 'analyzed' },
  { pair: 'GBP/JPY 30min', time: 'Yesterday, 3:15 PM', status: 'analyzed' },
  { pair: 'USD/CAD 45min', time: 'Jun 10, 2023', status: 'analyzed' },
];

const analysisGuides = [
  {
    icon: TrendingUp,
    title: 'Quick Market Structure',
    description: 'Identify micro support/resistance and structure for fast trades.',
  },
  {
    icon: TrendingUp,
    title: 'Momentum Analysis',
    description: 'Spot short-term momentum shifts for scalp entries.',
  },
  {
    icon: TrendingUp,
    title: 'Entry & Exit Points',
    description: 'Define precise entries, tight stop loss and quick profit targets.',
  },
];

const TIMEFRAMES = ['15m', '30min', '45min'];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">15m, 30min, 45min Timeframes</p>
        </div>
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="text-slate-400 text-sm">Learn the key components of effective scalping analysis</p>
              </div>
